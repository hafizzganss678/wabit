...
//      m.exp += Math.ceil(Math.random() * 10)
	...
	if (!m.fromMe && m.text.match(/(6285892842367)/gi)) {
stiker = await sticker(false, "https://i.ibb.co/ChLWyJZ/9f128d27fd0d.jpg", "ARAA-BOTZ", "Ngetag lagi saya bannet")
...
global.dfail = (type, m, conn) => {
  let msg = {
    ...
    owner: 'Hayoloh mau ngapain, kata owner ndak bole',
    mods: 'Hayoloh mau ngapain, kata owner ndak bole',
