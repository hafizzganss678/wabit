let handler = async(m, { conn, args, usedPrefix }) => {
    ...
    if (args[0] == 'ANDYyYY' || args[0] == '4ndY' || args[0] == 'A4557knJQ1' || args[0] == 'ARACANS') {

     await conn.send2Button(m.chat, "*SELAMAT!*\n\nKamu telah mendapatkan\nXP 99999999999\nMONEY 99999999999\nDan LIMIT 99999999999", '© A R A A - B O T Z', 'Get again', '.randomARACANS, 'Goprem', '.goprem', { sendEphemeral: true, quoted: m })
   ...
   await conn.sendButton(m.chat, "*KODE RANDOM TIDAK VALID!*\n\nSilahkan hubungi Owner untuk beli kode random yang valid dengan cara ketik !belikode atau dapatkan kode random secara gratis dengan cara menghubungi owner!", '© A R A A - B O T Z', 'Belikode', '.belikode', { sendEphemeral: true, quoted: m })}
